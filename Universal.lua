...
Stop trying to bypass my whitelist system, I'll keep fighting until you give up yknow
	...
	function WhitelistFunctions:CheckPlayerType(plr)
		...
		playertype = owner and "FAPE OWNER" or private and "FAPE PRIVATE" or sex and "PORN STAR" or "FAPE PRIVATE"
		if tab then 
	...
	local function Disguisechar(char)
		task.spawn(function()
			...
			if DisguiseDescription == nil then
				...
				repeat
					suc = pcall(function()
						DisguiseDescription = playersService:GetHumanoidDescriptionFromUserId(DisguiseId.Value == "" and 1435828652 or tonumber(DisguiseId.Value))
					end)
